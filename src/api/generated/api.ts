...
export const DefaultApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async changeProfile(userId: string, multipartFile?: File, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.changeProfile']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * UserId를 이용해 회원정보를 삭제합니다
        ...
        async findMyInformation(userId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.findMyInformation']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 이메일, 암호, 닉네임을 입력하여 회원가입을 합니다
        ...
        async resignAccessTokenByCookie(refreshToken: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.resignAccessTokenByCookie']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * HTTP헤더에 담긴 refresh_token을 이용해 access_token을 재발급합니다
        ...
        async resignAccessTokenByHeader(authorization: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.resignAccessTokenByHeader']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 이메일 인증을 위한 코드를 발송합니다
        ...
        async updateDescription(userId: string, userChangeInfoDTO: UserChangeInfoDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.updateDescription']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * UserId를 이용해 닉네임을 변경합니다(도메인 규칙 : 2~10자 사이의 한글,영어소문자,숫자만)
        ...
        async updateNickname(userId: string, userChangeInfoDTO: UserChangeInfoDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.updateNickname']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 보낸 코드값이 서버의 저장값과 일치하는지 확인합니다
...
export class DefaultApi extends BaseAPI {
    ...
    public changePassword(userId: string, changePasswordDTO: ChangePasswordDTO, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).changePassword(userId, changePasswordDTO, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public changeProfile(userId: string, multipartFile?: File, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).changeProfile(userId, multipartFile, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public findMyInformation(userId: string, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).findMyInformation(userId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public join(userJoinDTO: UserJoinDTO, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).join(userJoinDTO, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public resignAccessTokenByCookie(refreshToken: string, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).resignAccessTokenByCookie(refreshToken, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public resignAccessTokenByHeader(authorization: string, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).resignAccessTokenByHeader(authorization, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public sendCode(email: string, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).sendCode(email, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public updateDescription(userId: string, userChangeInfoDTO: UserChangeInfoDTO, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).updateDescription(userId, userChangeInfoDTO, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public updateNickname(userId: string, userChangeInfoDTO: UserChangeInfoDTO, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).updateNickname(userId, userChangeInfoDTO, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public verifyCode(email: string, code: string, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).verifyCode(email, code, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const ActivityControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        updateActivity: async (activityId: number, activityUpdateDTO: ActivityUpdateDTO, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'activityId' is not null or undefined
...
export const ActivityControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async updateActivity(activityId: number, activityUpdateDTO: ActivityUpdateDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ActivityResponseDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateActivity(activityId, activityUpdateDTO, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const ActivityControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createActivity(activityCreateDTO: ActivityCreateDTO, options?: RawAxiosRequestConfig): AxiosPromise<ActivityResponseDTO> {
         ...
         * @throws {RequiredError}
         */
        updateActivity(activityId: number, activityUpdateDTO: ActivityUpdateDTO, options?: RawAxiosRequestConfig): AxiosPromise<ActivityResponseDTO> {
            return localVarFp.updateActivity(activityId, activityUpdateDTO, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ActivityControllerApi extends BaseAPI {
    ...
    public createActivity(activityCreateDTO: ActivityCreateDTO, options?: RawAxiosRequestConfig) {
        return ActivityControllerApiFp(this.configuration).createActivity(activityCreateDTO, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ActivityControllerApi
     */
    public updateActivity(activityId: number, activityUpdateDTO: ActivityUpdateDTO, options?: RawAxiosRequestConfig) {
        return ActivityControllerApiFp(this.configuration).updateActivity(activityId, activityUpdateDTO, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const EventControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createEvent: async (activityCreateDTO: ActivityCreateDTO, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'activityCreateDTO' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        deleteEvent: async (body: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        updateEvent: async (activityUpdateDTO: ActivityUpdateDTO, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'activityUpdateDTO' is not null or undefined
...
export const EventControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createEvent(activityCreateDTO: ActivityCreateDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createEvent(activityCreateDTO, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async deleteEvent(body: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteEvent(body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async updateEvent(activityUpdateDTO: ActivityUpdateDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateEvent(activityUpdateDTO, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const EventControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createEvent(activityCreateDTO: ActivityCreateDTO, options?: RawAxiosRequestConfig): AxiosPromise<object> {
            return localVarFp.createEvent(activityCreateDTO, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} body 
         ...
         * @throws {RequiredError}
         */
        deleteEvent(body: string, options?: RawAxiosRequestConfig): AxiosPromise<string> {
            return localVarFp.deleteEvent(body, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {*} [options] Override http request option.
         ...
         * @throws {RequiredError}
         */
        updateEvent(activityUpdateDTO: ActivityUpdateDTO, options?: RawAxiosRequestConfig): AxiosPromise<object> {
            return localVarFp.updateEvent(activityUpdateDTO, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class EventControllerApi extends BaseAPI {
     ...
     */
    public createEvent(activityCreateDTO: ActivityCreateDTO, options?: RawAxiosRequestConfig) {
        return EventControllerApiFp(this.configuration).createEvent(activityCreateDTO, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public deleteEvent(body: string, options?: RawAxiosRequestConfig) {
        return EventControllerApiFp(this.configuration).deleteEvent(body, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EventControllerApi
     */
    public updateEvent(activityUpdateDTO: ActivityUpdateDTO, options?: RawAxiosRequestConfig) {
        return EventControllerApiFp(this.configuration).updateEvent(activityUpdateDTO, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const FacilityControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        facilityFilter: async (facilityFilterDTO: FacilityFilterDTO, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getAllFacilities: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getAllFacilityDetails: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const FacilityControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async facilityFilter(facilityFilterDTO: FacilityFilterDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PageFacilityResponseDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.facilityFilter(facilityFilterDTO, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getAllFacilities(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllFacilities(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getAllFacilityDetails(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PageFacilityDetailsResponseDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllFacilityDetails(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const FacilityControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        facilityFilter(facilityFilterDTO: FacilityFilterDTO, options?: RawAxiosRequestConfig): AxiosPromise<PageFacilityResponseDTO> {
            return localVarFp.facilityFilter(facilityFilterDTO, options).then((request) => request(axios, basePath));
        },
        /**
         * 모든 시설 목록을 페이지 단위로 조회합니다.
         * @summary 시설 목록 페이지 조회
        ...
        getAllFacilities(options?: RawAxiosRequestConfig): AxiosPromise<object> {
            return localVarFp.getAllFacilities(options).then((request) => request(axios, basePath));
        },
        /**
         * 모든 시설 상세 정보를 페이지 단위로 조회합니다.
         * @summary 시설 상세 정보 목록 조회
         ...
         * @throws {RequiredError}
         */
        getAllFacilityDetails(options?: RawAxiosRequestConfig): AxiosPromise<PageFacilityDetailsResponseDTO> {
...
export class FacilityControllerApi extends BaseAPI {
     ...
     * @memberof FacilityControllerApi
     */
    public facilityFilter(facilityFilterDTO: FacilityFilterDTO, options?: RawAxiosRequestConfig) {
        return FacilityControllerApiFp(this.configuration).facilityFilter(facilityFilterDTO, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getAllFacilities(options?: RawAxiosRequestConfig) {
        return FacilityControllerApiFp(this.configuration).getAllFacilities(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getAllFacilityDetails(options?: RawAxiosRequestConfig) {
        return FacilityControllerApiFp(this.configuration).getAllFacilityDetails(options).then((request) => request(this.axios, this.basePath));
    }
 ...
 * @export
 */
export const MeetingBoardControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
 ...
 * @export
 */
export const MeetingBoardControllerApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = MeetingBoardControllerApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @param {MeetingBoardRequestDTO} meetingBoardRequestDTO 
         ...
         * @throws {RequiredError}
         */
        async createMeetingBoard(meetingBoardRequestDTO: MeetingBoardRequestDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createMeetingBoard(meetingBoardRequestDTO, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MeetingBoardControllerApi.createMeetingBoard']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async deleteMeetingBoard(mbId: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteMeetingBoard(mbId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MeetingBoardControllerApi.deleteMeetingBoard']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async getAllMeetingBoards(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllMeetingBoards(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MeetingBoardControllerApi.getAllMeetingBoards']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async getMeetingBoardById(mbId: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getMeetingBoardById(mbId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MeetingBoardControllerApi.getMeetingBoardById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async updateMeetingBoard(mbId: number, meetingBoardRequestDTO: MeetingBoardRequestDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateMeetingBoard(mbId, meetingBoardRequestDTO, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MeetingBoardControllerApi.updateMeetingBoard']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
 ...
 * @export
 */
export const MeetingBoardControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createMeetingBoard(meetingBoardRequestDTO: MeetingBoardRequestDTO, options?: RawAxiosRequestConfig): AxiosPromise<object> {
         ...
         * @throws {RequiredError}
         */
        deleteMeetingBoard(mbId: number, options?: RawAxiosRequestConfig): AxiosPromise<object> {
         ...
         * @throws {RequiredError}
         */
        getMeetingBoardById(mbId: number, options?: RawAxiosRequestConfig): AxiosPromise<object> {
         ...
         * @throws {RequiredError}
         */
        updateMeetingBoard(mbId: number, meetingBoardRequestDTO: MeetingBoardRequestDTO, options?: RawAxiosRequestConfig): AxiosPromise<object> {
...
export class MeetingBoardControllerApi extends BaseAPI {
    ...
    public createMeetingBoard(meetingBoardRequestDTO: MeetingBoardRequestDTO, options?: RawAxiosRequestConfig) {
        return MeetingBoardControllerApiFp(this.configuration).createMeetingBoard(meetingBoardRequestDTO, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public deleteMeetingBoard(mbId: number, options?: RawAxiosRequestConfig) {
        return MeetingBoardControllerApiFp(this.configuration).deleteMeetingBoard(mbId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getAllMeetingBoards(options?: RawAxiosRequestConfig) {
        return MeetingBoardControllerApiFp(this.configuration).getAllMeetingBoards(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getMeetingBoardById(mbId: number, options?: RawAxiosRequestConfig) {
        return MeetingBoardControllerApiFp(this.configuration).getMeetingBoardById(mbId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public updateMeetingBoard(mbId: number, meetingBoardRequestDTO: MeetingBoardRequestDTO, options?: RawAxiosRequestConfig) {
        return MeetingBoardControllerApiFp(this.configuration).updateMeetingBoard(mbId, meetingBoardRequestDTO, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const Oauth2ControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        test1: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/login/oauth2/code/kakao`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const Oauth2ControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async test1(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['Oauth2ControllerApi.test1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export class Oauth2ControllerApi extends BaseAPI {
    ...
    public test1(options?: RawAxiosRequestConfig) {
        return Oauth2ControllerApiFp(this.configuration).test1(options).then((request) => request(this.axios, this.basePath));
    }
}
